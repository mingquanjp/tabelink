...
| Review và social | `REVIEW`, `REVIEW_MEDIA`, `REVIEW_TAG` |
...
- `IsJapaneseTag` dùng để phân loại review có giá trị cho khách Nhật.
...
| `REVIEW_MEDIA` | Ảnh/video trong review | Thuộc review. |
| `HASHTAG` | Master hashtag | Dùng cho review tag, timeline, trend. |
| `REVIEW_TAG` | Gắn hashtag vào review | Bảng nối nhiều-nhiều. |
...
- `IsJapaneseTag`: đánh dấu review từ góc nhìn khách Nhật.
...
Lưu ảnh hoặc video của review.

#### `REVIEW_TAG`

Bảng nối nhiều-nhiều giữa review và hashtag.
