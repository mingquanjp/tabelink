...
export class SubmitVerificationApplicationDto {
  ...
  @ApiProperty({
    example:
      'https://res.cloudinary.com/demo/image/upload/v123/business-license.pdf',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    example: 'tabelink/restaurants/1/verification/business-license/license',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    example: 'tabelink/restaurants/1/verification/food-safety/certificate',
  })
  @IsString()
  @IsNotEmpty()
