...
def build_rows() -> list[tuple[str, list[Row], list[str], list[str] | None]]:
    ...
    restaurant_specs = [
        ...
        ("キムマー・牛肉フォー専門店", "ハノイ市バーディン区キムマー通り142番", Decimal("21.031420"), Decimal("105.821760"), "牛肉フォーを中心に朝食と昼食で使いやすい専門店です。"),
        ("ホアンキエム・鶏肉フォー食堂", "ハノイ市ホアンキエム区ハンボン通り58番", Decimal("21.028340"), Decimal("105.846980"), "あっさりした鶏肉フォーと日本語メニューに対応する旧市街の食堂です。"),
        ("リンラン・フォーと春巻き", "ハノイ市バーディン区リンラン通り24番", Decimal("21.034620"), Decimal("105.812980"), "フォーと春巻きを少人数でも注文しやすい形で提供します。"),
        ("タイハー・朝フォー屋", "ハノイ市ドンダー区タイハー通り76番", Decimal("21.013820"), Decimal("105.820640"), "朝から営業し、出勤前にも立ち寄りやすいフォー屋です。"),
    ]
